...
public class VotingTable implements Serializable {
    ...
    public boolean addedToElection;
   ...
   /* public VotingTable(String department, Boolean state, String address){
	...
	public boolean isAddedToElection() {
		return addedToElection;
	}

	public void setAddedToElection(boolean addedToElection) {
		this.addedToElection = addedToElection;
	}
}
