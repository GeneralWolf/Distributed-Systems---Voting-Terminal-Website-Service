 ...
 */
public class RmiClientStandalone {
    ...
    private RmiClientStandalone() {
        super();
    }

    public static void main(String[] args) throws IOException {
        RmiClientStandalone rmiClient = new RmiClientStandalone();
        boolean exit = false;
    ...
    private void createElection() throws RemoteException {
        String title, description, startDate, endDate, startHour, startMinute, endHour, endMinute, electionType, reply;
        ...
        for (List l: listsTemp) {
            if (l.getType().equals(electionType)) {
                lists.add(l);
            }
        }
        ...
        while (true) {
            try {
                reply = rmi.createElection(title, description, startDate, endDate, startHour, startMinute, endHour, endMinute, electionType, electionLists);
                break;
            } catch (ConnectException e) {
                //System.out.println("Error");
            }
