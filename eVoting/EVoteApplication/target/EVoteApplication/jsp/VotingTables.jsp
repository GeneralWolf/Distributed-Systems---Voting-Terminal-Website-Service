...
<body>
	...
	<div id="lstVotTable">
		<table> 
			...
			<c:forEach items="${listVotingTables}" var="votingTable" varStatus="loop">
			<tr> 
				...
				<td><table>
					...
					<c:forEach items="${votingTable.votingTerminals}" var="votingTerminal">
						<tr>
	...
	<div id="addForm" style="display:none;">
		...
		<form name="addVotingTableForm" action="AddVotingTable" method="post">
		<table> 
			<tr> 
		...
		<input id="btnAddForm" name="addVotingTable" type="submit" value="Add" />
		</form>
	</div>
</body>
</html>